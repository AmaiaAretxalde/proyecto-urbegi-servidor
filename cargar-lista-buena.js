...
// Connect to the db
mongoose.connect("mongodb://localhost:27017/urbegiT", function (err, client) {
  console.log(typeof client)
  
  if (err) {
    return console.dir(err);
  } else {
    // db = client.db("urbegiTeas")
    
    // db.collection('teas').insertMany(teas, function (err, r) {
    //   if(err){
    //     console.log(e)
    //     return err
        
    //   }
    // //   console.log("insertados " + r.insertedCount)
    // //   client.close();
 ...
 app.post('/api/teas', async function(req,res){
  let datos = req.body;
