let teas = [{
    ...
    //NUEVO
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad:  Vitamínica",
            "",
            "¡Quiero saber más!:  Sin teína, es apta para toda la familia. Con una nube de leche o bebida vegetal consigue potenciar el aroma a repostería casera.  ",
            "",
            "Ingredientes:   Manzana, algarroba, escaramujo, piña confitada, zanahoria, Rooibos, grosellas rojas, pétalos de cártamo, ",
            "",
            "",
            ""
        ],
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Antioxidante ",
            "",
            "¡Quiero saber más!: Esta deliciosa combinación de té blanco con manzana, mango, trocitos de caramelo y flores como la manzanilla romana nos evoca a la belleza de la Navidad con un aroma y sabor dulce e inconfundible",
            "",
            "Ingredientes:   La poesía de la Navidad: mezcla de té blanco con mango, el fruto del amor, manzana, caramelo, flores y aromas.",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "¡Es un TOP VENTAS! Basado en el Masala Chai al más puro estilo hindú. Increíble para degustar con leche de soja, tanto en caliente como en frío.",

            "Funcionalidad: Energizante ",
            "",
            "¡Quiero saber más!:BENEFICIOS:",
            "No contiene alérgenos.",
            "Ayuda a controlar el colesterol.",
            "Antiséptico y Expectorante.",

            "",
            "Ingredientes:   Mezcla de tés negros (India, China, Sri Lanka, Java), hinojo dulce, canela, jengibre, raíz de regaliz, pimienta rosa, clavos, aroma natural (nata, leche,vainilla, canela, cardamomo)",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Disfruta de nuestra mezcla ideal para la Navidad: un Té negro, ligero, dulce y nada amargo. Fluido e ideal para los amantes de sabores suaves, con toques afrutados y un agradable sabor a higo. ",
            "Se puede combinar con leche o bebida vegetal para potenciar ese toque dulzón del higo y los frutos secos tan típicos de la época navideña. ",

            "Funcionalidad: Energizante ",
            "",
            "¡Quiero saber más!:ALÉRGENOS: Contiene frutos secos.",
            "BENEFICIOS:",
            "Dentro de la familia de los tés energéticos, tiene una funcionalidad tonificante.",
            "La algarroba de sabor dulce con un retrogusto a chocolate ayuda a regular la digestión.",
            "Tonificante y digestivo.",
            "",
            "Ingredientes:  Té negro, dátiles y harina de arroz, algarroba, pasas, pistacho, caléndula, cártamo y aromas de higo, frutos rojos, ciruelas, canela, anís estrellado y azúcar moreno.",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Digestivo ",
            "",
            "¡Quiero saber más!:Otras funcionalidades: Antiinflamatorio",
            "",
            "Ingredientes:  Pu Erh, dátiles, pasas, aroma, trozos de jengibre,trozos de cúrcuma, cúrcuma en polvo, trocitos de coco, anís estrellado, algarroba y trocitos de pistacho",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Antioxidante ",
            "",
            "¡Quiero saber más!: El Kukicha tiene efectos remineralizantes pues es rico en calcio, zinc, flúor y magnesio. Es alcalinizante siendo capaz de neutralizar la acidez de los tejidos y fluidos de nuestro cuerpo (resultado de un exceso de carnes, lácteos, harinas refinadas, etc… en nuestra alimentación) equilibrando sus niveles y previniendo múltiples enfermedades. El aporte de teína también es menor que en otras variedades de Té verde. Un aroma y sabor envolventes para los amantes de Kukicha.",
            "",
            "Ingredientes:  Té verde orgánico de Japón",
            "",
            "",
            ""
        ],
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "",
            "¡Quiero saber más!: Cálido e ideal para calentar el cuerpo en los días fríos. Perfecto con repostería especiada.",

            ,
            "",
            "Ingredientes:  Rooibos, almendra, cáscara de naranja, manzana, canela, clavo, pétalos de aciano, aroma de almendra, aroma natural de canela, aceite de naranja.",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Vitamínica ",
            "",
            "¡Quiero saber más!: Al estilo de los bazares de Estambul, se puede tomar sola, en frío o caliente, o bien mezclar la infusión con zumos de frutas para preparar deliciosas bebidas veraniegas.",

            ,
            "",
            "Ingredientes:  Manzana, pulpa de manzana , hojas de mora dulce, ácido cítrico",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Digestivo ",
            "",
            "¡Quiero saber más!: Una armoniosa combinación en la que predomina en boca el sabor de la miel. Con efecto reconfortante es la opción perfecta para relajarse y desconectar de la rutina diaria.",

            ,
            "",
            "Ingredientes:  Manzana, hojas de tilo, hojas de zarzamora, flor de tilo, cáscara de escaramujo, melisa, anís estrellado,",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Relajante ",
            "",
            "¡Quiero saber más!: BENEFICIOS: Alivia y previene la falta de deposiciones ",

            ,
            "",
            "Ingredientes:  Manzana, manzanilla, canela, aroma de manzana y aroma de canela.",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Vitamínico ",
            "",
            "¡Quiero saber más!: Refrescante y ligeramente dulce ",

            ,
            "",
            "Ingredientes: Hibisco, piña confitada, papaya confitada, pasas de corinto, cáscara de escaramujo, cáscara de naranja",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Revitalizante ",
            "",
            "¡Quiero saber más!: Refrescante y ligeramente dulce ",

            ,
            "",
            "Ingredientes:  Cascara de cacao orgánico, jengibre, peladura de naranja, cártamo",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Antioxidante ",
            "",
            "¡Quiero saber más!: Diurético ",

            ,
            "",
            "Ingredientes:  Infusión de bayas de goji, hibisco, pepitas de granada, arándanos, manzana, hojas de zarzamora, cáscara de escaramujo",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Relajante ",
            "",
            "¡Quiero saber más!:Una placentera composición para los amantes de este dulce con un suave toque herbal.  ",

            ,
            "",
            "Ingredientes:  Manzana, raíz de regaliz, canela, semillas de anís, menta piperita, hojas de zarzamora, cítricos y cáscara de citricos, anís estrellado, hierba luisa, pétalos de girasol",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Revitalizante ",
            "",
            "¡Quiero saber más!:Infusión muy energética.  ",

            ,
            "",
            "Ingredientes:  Hinojo, cáscara de naranja, canela Cassia, raíz de regaliz, clavo, jengibre, cardamomo, enebro, pimienta verde.",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Revitalizante ",
            "",
            "¡Quiero saber más!:Infusión tonificante y digestiva,para recuperar el \"espíritu\".  ",

            ,
            "",
            "Ingredientes:  Canela orgánica, jengibre, clavo y semillas de cardamomo ",
    ...
    },
    {
        ...
        "longDescription": [
            ...
            "Funcionalidad: Relajante ",
            "",
            "¡Quiero saber más!:Infusión caprichosa con sabor fresco del bosque ",

            ,
            "",
            "Ingredientes:  Manzana, hibisco, hojas de mora, hojas de frambuesa, manzanilla, pétalos de girasol, frambuesa, menta piperita, hierbabuena",
